...
<!--
		...
		<td><button id="button<?php echo $fieldName; ?>" name="<?php echo $fieldName; ?>" type="submit" class="btn btn-success btn-xs" style="width:80px;" onClick="hideRow<?php echo $stdList[13]; ?>.setAttribute('class', 'success');">
		<i class="icon-ok icon-white"></i> Start</button></td>
		</form>
		-->
...
<!--
		...
		<td><button id="cancel<?php echo $fieldName; ?>" name="cancel<?php echo $fieldName; ?>" type="submit" class="btn btn-success btn-xs" onClick="return confirm('Are you sure you want to cancel <?php echo $stdList[1]; ?> from <?php echo $epName; ?>')">
		<i class="icon-remove icon-white"></i> Cancel</button></td>
		</form>
		-->
