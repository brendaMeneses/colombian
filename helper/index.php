...
<?php include "../inc/navigation.php"; ?>
    <div class="container" style="border: 0;">
        <h3 style="letter-spacing: -1px;"><span
            ...
            Fair
            <small>School List for school helpers</small>
        </h3>
    </div>
    <div class="container" style="margin-top: -60px;">
        ...
        while ($epList = mysqli_fetch_array($sql)) {
            echo "<div class='span2 well well-small col-xs-6 col-sm-4' style='font-size: 16px; text-align: center;'><a href='helper/helper_list.php?EPname=" . $epList['epName'] . "' target='_blank'>" . substr($epList['epName'], 0, -6) . "</a></div> ";
        }
        ?>
    </div>
