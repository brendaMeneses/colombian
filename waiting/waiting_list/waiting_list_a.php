...
<?php
	$epName = $_GET['EPname'];
	if($epName=="TAFE Queensland-S89aA"){echo "http://iaemember.com/studyfair2016/waiting_list_a.php?EPname=QAT-gueEd";}
	else if($epName=="QAT-gueEd"){echo "http://iaemember.com/studyfair2016/waiting_list_a.php?EPname=Embassy-fiEde";}
	else if($epName=="Embassy-fiEde"){echo "http://iaemember.com/studyfair2016/waiting_list_a.php?EPname=ILSC-biEDe";}
	else if($epName=="ILSC-biEDe"){echo "http://iaemember.com/studyfair2016/waiting_list_a.php?EPname=Navitas English-oodED";}
	else if($epName=="Navitas English-oodED"){echo "http://iaemember.com/studyfair2016/waiting_list_a.php?EPname=Browns-38Fed";}
	else if($epName=="Browns-38Fed"){echo "http://iaemember.com/studyfair2016/waiting_list_a.php?EPname=ALS-B7eDe";}
	else if($epName=="ALS-B7eDe"){echo "http://iaemember.com/studyfair2016/waiting_list_a.php?EPname=TAFE Queensland-S89aA";}
?>" >
