...
<?php
	$epName = $_GET['EPname'];
	if($epName=="Kaplan-buEdj"){echo "http://iaemember.com/studyfair2016/waiting_list_total.php?EPname=UQ-9jIUE";}
	else if($epName=="UQ-9jIUE"){echo "http://iaemember.com/studyfair2016/waiting_list_total.php?EPname=Griffith-89hH9";}
	else if($epName=="Griffith-89hH9"){echo "http://iaemember.com/studyfair2016/waiting_list_total.php?EPname=CQU-IUPde";}
	else if($epName=="CQU-IUPde"){echo "http://iaemember.com/studyfair2016/waiting_list_total.php?EPname=USQ-2985A";}
	else if($epName=="USQ-2985A"){echo "http://iaemember.com/studyfair2016/waiting_list_total.php?EPname=USC-18iud";}
	else if($epName=="USC-18iud"){echo "http://iaemember.com/studyfair2016/waiting_list_total.php?EPname=QUT-3bjE4";}
	else if($epName=="QUT-3bjE4"){echo "http://iaemember.com/studyfair2016/waiting_list_total.php?EPname=Peter Migration-389cd";}
	else if($epName=="Peter Migration-389cd"){echo "http://iaemember.com/studyfair2016/waiting_list_total.php?EPname=Namo Migration-r95jF";}
	else if($epName=="Namo Migration-r95jF"){echo "http://iaemember.com/studyfair2016/waiting_list_total.php?EPname=Others-49b2a";}
	else if($epName=="Others-49b2a"){echo "http://iaemember.com/studyfair2016/waiting_list_total.php?EPname=Kaplan-buEdj";}
?>" >
    ...
    <div class="container" style="margin-top: 50px; width: 95%;">
    	<legend style="font-size: 80px; height:100px; margin-top: 20px;">
    		<?php
				...
				else if($epName=="ALS-B7eDe"){echo "<span style='background: black; color: white; maring: 5px;'>09</span>~<span style='background: black; color: white; maring: 5px;'>10</span> ih-ALS";}
		    ...
		    <?php
				$sql = mysqli_query($con, "SELECT familyName, firstName, gender, currentc, currents, interestc, interestm, nationality, cnslDate, id, tr_class, epName, startdate, unique_id, phone, email, memo_ep, start_time, finish_time, counselling_memo, rate, SMS
FROM stdList WHERE epName = '$epName' ORDER BY cnslDate ASC") or die(mysqli_error());
